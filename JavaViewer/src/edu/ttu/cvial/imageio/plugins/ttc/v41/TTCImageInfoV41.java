 ...
 */
public class TTCImageInfoV41 {
    
    public static String fileType = "TTC";

    public static String version = "4.1";

    public static final String classSuffix = "V41";
    ...
    public static final String packageName = TTCImageInfoV41.class.getPackage().getName();
    ...
    public static boolean foundSignature(Object input) {
        ...
        byte signature[] = TTCImageInfoV41.getSignatureBytes();
